...
module.exports = {
    win32: {
        ...
        files: { // First file must be the executable
            ...
            '>=0.13.0-beta.1': ['nw.exe', 'icudtl.dat', 'libEGL.dll', 'libGLESv2.dll', 'locales', 'd3dcompiler_47.dll', "dbghelp.dll","natives_blob.bin","node.dll","nw.dll","nw_100_percent.pak","nw_200_percent.pak","nw_elf.dll","resources.pak","snapshot_blob.bin"]
        },
